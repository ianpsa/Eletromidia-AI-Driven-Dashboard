...
Aqui, o VPC foi usado para mostrar como a Plataforma de BI (Looker) e o Mapa Hexbin atendem às necessidades das [personas](/docs/sprint-1/perfil-do-parceiro/personas) Mário (executivo) e Carmen (analista) dentro da Eletromidia.

![Value Proposition Canvas do projeto Midia in da House mostrando a proposta de valor com Plataforma de BI e Mapa Hexbin no lado esquerdo e as tarefas, ganhos e dores do cliente no lado direito](/vpc.png)
